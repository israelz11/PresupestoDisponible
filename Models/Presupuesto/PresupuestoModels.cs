    ...
    public class PresupuestoModels
    {
        ...
        public string uploadfiles(HttpPostedFileBase fileInput1, HttpPostedFileBase fileInput2, HttpServerUtilityBase server)
        {
            try
            {
                ...
                string FileName2 = TempDirectory + "Layout_" + fileInput2.FileName;

                fileInput1.SaveAs(FileName1);
                fileInput2.SaveAs(FileName2);

                Stream stream1 = fileInput1.InputStream;
                Stream stream2 = fileInput2.InputStream;
                ...
                DataTable TSheet2 = result2.Tables[0];
                ...
                this.saveDatabase(data,TSheet2.Rows);
        ...
        #region Database
        public string saveDatabase(List<DataPresupuesto> data, DataRowCollection data2) {
            try
            {
